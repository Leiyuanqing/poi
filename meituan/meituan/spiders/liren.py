...
class LirenSpider(scrapy.Spider):
    name = 'liren'
    ...
    with open("beijing.json", 'r', encoding='utf-8') as json_f:
        ...
        for i in beijing:
            ...
            url = 'http://' + i.get("city_acronym") + ".meituan.com/jiankangliren/renqi/"
            urls.append(url)
